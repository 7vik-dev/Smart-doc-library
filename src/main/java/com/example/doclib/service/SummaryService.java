...
public class SummaryService {
    ...
    public void generateSummaryAsync(String documentId) {
        log.info("🔄 [ASYNC START] Summary generation started for document: {}", documentId);
        log.info("   Thread: {} (this is NOT the HTTP request thread!)", Thread.currentThread().getName());

        // Update status to PROCESSING so frontend can show a spinner
        ...
        try {
            ...
            //   - Running NLP model locally
            //   - Complex text analysis
            // Thread.sleep simulates the delay without real work.
            // =====================================================
            log.info("   💤 Simulating heavy AI processing (5 seconds)...");
            Thread.sleep(5000);
            ...
            // Save the completed summary back to MongoDB
